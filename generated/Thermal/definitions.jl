...
include("CloudLatch_definition.jl")
include("CompartmentStillAnalysis_definition.jl")
include("CompartmentStill_definition.jl")
include("ConvRadSunWall_definition.jl")
include("ConvectionHorizontalCylinder_definition.jl")
include("ConvectionSpeedSweepAnalysis_definition.jl")
include("ConvectionSpeedSweep_definition.jl")
...
include("DeckhouseAtSeaAnalysis_definition.jl")
include("DeckhouseAtSea_definition.jl")
include("EnvironmentHeatTransfer_definition.jl")
include("ExternalConvection_definition.jl")
include("InternalConvectionCrossoverAnalysis_definition.jl")
include("InternalConvectionCrossover_definition.jl")
include("InternalConvection_definition.jl")
include("IrradiationOnPlane_definition.jl")
include("PlateForcedConvection_definition.jl")
include("PlateHeatup_definition.jl")
include("PlateTransientAnalysis_definition.jl")
include("PlateTransient_definition.jl")
include("ShipCompartment_definition.jl")
...
include("SunWallDay_definition.jl")
include("SunWallSummerAnalysis_definition.jl")
include("SunWallWinterAnalysis_definition.jl")
include("TemperatureDataset_definition.jl")
include("WeatherDayTransient_definition.jl")
include("WeatherDay_definition.jl")