...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Propulsion", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Propulsion", "definitions.jl"))
end
