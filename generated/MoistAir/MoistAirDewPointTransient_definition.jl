...
@kwdef mutable struct MoistAirDewPointTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :MoistAirDewPointTransient
  ...
  var"model"::Union{Nothing, System} = DyadShip.MoistAir.MoistAirDewPoint(; name=:MoistAirDewPoint)
end

function DyadInterface.run_analysis(spec::MoistAirDewPointTransientSpec)
...
MoistAirDewPointTransient(;kwargs...) = run_analysis(MoistAirDewPointTransientSpec(;kwargs...))
export MoistAirDewPointTransient, MoistAirDewPointTransientSpec
