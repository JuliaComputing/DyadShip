...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Machinery", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Machinery", "definitions.jl"))
end
