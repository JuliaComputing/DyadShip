...
@doc Markdown.doc"""
   FourWingSailsAHTanks(; name, U0, J_shaft, rpm, sail_angle, wind_speed, wind_direction)
...
"""
@component function FourWingSailsAHTanks(; name = nothing, U0=Float64(7), J_shaft=Float64(4000), rpm=Float64(100), sail_angle=Float64(50), wind_speed=Float64(15), wind_direction=Float64(0), kwargs...)
  isnothing(name) && throw(ArgumentError("""
    The `name` keyword must be provided. Please consider using the `@named` macro,
    like so:
  
    @named model = FourWingSailsAHTanks()
  """))
  ...
  # Subcomponent tank_port of type DyadShip.Ship6DOF.BallastTank
  tank_port_overrides = __pop_subcomponent_overrides!(__overrides, "tank_port")
  push!(__systems, @named tank_port = DyadShip.Ship6DOF.BallastTank(; r_tank=[Float64(50), Float64(8), Float64(1)], V=Float64(100), H=Float64(5), tank_port_overrides...))
  # Subcomponent tank_starboard of type DyadShip.Ship6DOF.BallastTank
  tank_starboard_overrides = __pop_subcomponent_overrides!(__overrides, "tank_starboard")
  push!(__systems, @named tank_starboard = DyadShip.Ship6DOF.BallastTank(; r_tank=[Float64(50), Float64(-8), Float64(1)], V=Float64(100), H=Float64(5), tank_starboard_overrides...))
  ...
  push!(__eqs, connect(ship.frame_a, antiheeling.frame_a, tank_port.frame_a, tank_starboard.frame_a))

  # Return completely constructed System
  return System(__eqs, t, __vars, __params; systems=__systems, initial_conditions=__initial_conditions, guesses=__guesses, name, initialization_eqs=__initialization_eqs, bindings=__bindings, assertions=__assertions)
end
export FourWingSailsAHTanks
