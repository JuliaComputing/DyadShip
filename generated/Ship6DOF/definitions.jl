...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Ship6DOF", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Ship6DOF", "definitions.jl"))
end
...
import IncompressibleFlowComponents
...
include("BunkeringTransient_definition.jl")
include("Bunkering_definition.jl")
include("CableBreakLatch_definition.jl")
include("Cable_definition.jl")
include("CentrifugalPump_definition.jl")
include("CraneOperationTransient_definition.jl")
include("CraneOperation_definition.jl")
include("Crane_definition.jl")
include("CrashStopTransient_definition.jl")
include("CrashStop_definition.jl")
include("FourWingSailsAHCircuitTransient_definition.jl")
include("FourWingSailsAHCircuit_definition.jl")
...
include("FourWingSails_definition.jl")
include("FuelTank_definition.jl")
include("FullShip6DOFTransient_definition.jl")
include("FullShip6DOF_definition.jl")
include("HydrodynamicXYY_definition.jl")
include("HydrodynamicZRP_definition.jl")
include("ManualShip6DOFTransient_definition.jl")
include("ManualShip6DOF_definition.jl")
include("POD4Q_definition.jl")
include("PodTurningCircleTransient_definition.jl")
include("PodTurningCircle_definition.jl")
include("Propeller1Q_definition.jl")
include("Propeller4Q_definition.jl")
include("RollDecayTMDTransient_definition.jl")
include("RollDecayTMD_definition.jl")
include("RollDecayTransient_definition.jl")
include("RollDecay_definition.jl")
include("RollTunedMassDamper_definition.jl")
include("RudderReturnTransient_definition.jl")
include("RudderReturn_definition.jl")
include("Rudder_definition.jl")
include("ShipBody_definition.jl")
include("ShipWind_definition.jl")
include("SpeedTrialTransient_definition.jl")
include("SpeedTrial_definition.jl")
include("TankLiquidMass_definition.jl")
...
include("WaypointTransitTransient_definition.jl")
include("WaypointTransit_definition.jl")
include("WingSailSweepTransient_definition.jl")
include("WingSailSweep_definition.jl")
include("WingSail_definition.jl")
include("ZigZagController_definition.jl")
include("ZigZagRelay_definition.jl")
include("ZigZagTransient_definition.jl")
include("ZigZag_definition.jl")