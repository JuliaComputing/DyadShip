...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "Ship", "definitions.jl"))
...
include("FullShipFlettnerRender_definition.jl")
include("FullShipRender_definition.jl")
include("FullShip_definition.jl")
include("HeadingAutoPilot_definition.jl")
include("HullMMG_definition.jl")
include("ManualShipTransient_definition.jl")
include("ManualShip_definition.jl")
include("RudderReturn2DTransient_definition.jl")
include("RudderReturn2D_definition.jl")
include("ShipDisturbedTransient_definition.jl")
include("ShipFlettnerFavorableRenderTransient_definition.jl")
include("ShipFlettnerOnlineRenderTransient_definition.jl")
include("ShipFlettnerRenderTransient_definition.jl")
include("ShipRenderTransient_definition.jl")
include("ShipTransient_definition.jl")
include("ShipWind_definition.jl")
include("Tank_definition.jl")